        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            {solution.startingPrice && (
              <p className="text-gold/80 text-sm font-semibold mt-4">
                Starting from {solution.startingPrice} &middot;{" "}
        ...
        <section className="py-16 bg-navy-dark">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto mb-8">
              Final pricing depends on complexity, number of users,
              integrations, and customization requirements. All projects include
              team training and 3 months of post-launch support.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href={`https://wa.me/918793630001?text=${encodeURIComponent(
                  `Hi, I'd like a detailed quote for the "${solution.title}" solution.`
                )}`}
                target="_blank"
              ...
              <Link
                href="/contact"
                className="inline-flex items-center justify-center border-2 border-white/30 hover:border-white text-white px-8 py-4 rounded-md font-bold text-lg transition-colors"
              >
                Send Enquiry
              </Link>
            </div>
