      ...
      <>
        <section className="bg-navy-dark py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 animate-pulse">
            <div className="bg-white/10 rounded h-4 w-32 mb-4" />
            <div className="bg-white/10 rounded h-10 w-3/4 mb-4" />
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 animate-pulse space-y-4">
            ...
            <div className="bg-gray-100 rounded h-4 w-full" />
            <div className="bg-gray-100 rounded h-4 w-4/6" />
          </div>
        </section>
      </>
    );
  ...
  if (!post) {
    return (
      <section className="py-32 bg-white text-center">
        <h1 className="text-2xl font-bold text-navy-dark mb-4">
          Post Not Found
        </h1>
        <Link
          href="/blog"
          ...
          <div className="flex flex-wrap items-center gap-3 mb-4">
            {post.category &&
              post.category.map((cat) => (
                <span key={cat} className="text-xs font-bold text-gold uppercase tracking-wide bg-gold/10 px-3 py-1 rounded-full">
                  {cat}
                </span>
              ))}
          </div>
